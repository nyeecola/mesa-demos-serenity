/*
    ...
    WGL loader generated by glad 0.1.11a0 on Fri Aug  5 11:30:21 2016.
    ...
    Profile: -
    Extensions:
        WGL_NV_multisample_coverage, WGL_I3D_image_buffer, WGL_I3D_swap_frame_usage, WGL_NV_DX_interop2, WGL_OML_sync_control, WGL_NV_float_buffer, WGL_NV_delay_before_swap, WGL_NV_video_capture, WGL_ARB_pixel_format_float, WGL_ARB_create_context_profile, WGL_NV_swap_group, WGL_NV_gpu_affinity, WGL_EXT_pixel_format, WGL_ARB_extensions_string, WGL_NV_render_texture_rectangle, WGL_EXT_create_context_es_profile, WGL_ARB_robustness_share_group_isolation, WGL_ARB_create_context_robustness, WGL_EXT_depth_float, WGL_EXT_swap_control_tear, WGL_ARB_context_flush_control, WGL_ARB_pixel_format, WGL_ARB_multisample, WGL_I3D_genlock, WGL_NV_vertex_array_range, WGL_3DL_stereo_control, WGL_EXT_pbuffer, WGL_EXT_display_color_table, WGL_NV_video_output, WGL_ARB_robustness_application_isolation, WGL_3DFX_multisample, WGL_I3D_gamma, WGL_ARB_framebuffer_sRGB, WGL_NV_copy_image, WGL_EXT_framebuffer_sRGB, WGL_NV_present_video, WGL_EXT_create_context_es2_profile, WGL_ARB_render_texture, WGL_ARB_make_current_read, WGL_EXT_multisample, WGL_ARB_create_context, WGL_EXT_extensions_string, WGL_NV_render_depth_texture, WGL_ATI_pixel_format_float, WGL_EXT_swap_control, WGL_I3D_digital_video_control, WGL_ARB_pbuffer, WGL_NV_DX_interop, WGL_AMD_gpu_association, WGL_EXT_pixel_format_packed_float, WGL_EXT_make_current_read, WGL_I3D_swap_frame_lock, WGL_ARB_buffer_region
    Loader: True
    Local files: False
    Omit khrplatform: False

    Commandline:
        --api="wgl=1.0" --generator="c" --spec="wgl" --extensions="WGL_NV_multisample_coverage,WGL_I3D_image_buffer,WGL_I3D_swap_frame_usage,WGL_NV_DX_interop2,WGL_OML_sync_control,WGL_NV_float_buffer,WGL_NV_delay_before_swap,WGL_NV_video_capture,WGL_ARB_pixel_format_float,WGL_ARB_create_context_profile,WGL_NV_swap_group,WGL_NV_gpu_affinity,WGL_EXT_pixel_format,WGL_ARB_extensions_string,WGL_NV_render_texture_rectangle,WGL_EXT_create_context_es_profile,WGL_ARB_robustness_share_group_isolation,WGL_ARB_create_context_robustness,WGL_EXT_depth_float,WGL_EXT_swap_control_tear,WGL_ARB_context_flush_control,WGL_ARB_pixel_format,WGL_ARB_multisample,WGL_I3D_genlock,WGL_NV_vertex_array_range,WGL_3DL_stereo_control,WGL_EXT_pbuffer,WGL_EXT_display_color_table,WGL_NV_video_output,WGL_ARB_robustness_application_isolation,WGL_3DFX_multisample,WGL_I3D_gamma,WGL_ARB_framebuffer_sRGB,WGL_NV_copy_image,WGL_EXT_framebuffer_sRGB,WGL_NV_present_video,WGL_EXT_create_context_es2_profile,WGL_ARB_render_texture,WGL_ARB_make_current_read,WGL_EXT_multisample,WGL_ARB_create_context,WGL_EXT_extensions_string,WGL_NV_render_depth_texture,WGL_ATI_pixel_format_float,WGL_EXT_swap_control,WGL_I3D_digital_video_control,WGL_ARB_pbuffer,WGL_NV_DX_interop,WGL_AMD_gpu_association,WGL_EXT_pixel_format_packed_float,WGL_EXT_make_current_read,WGL_I3D_swap_frame_lock,WGL_ARB_buffer_region"
    Online:
        http://glad.dav1d.de/#language=c&specification=wgl&loader=on&api=wgl%3D1.0&extensions=WGL_NV_multisample_coverage&extensions=WGL_I3D_image_buffer&extensions=WGL_I3D_swap_frame_usage&extensions=WGL_NV_DX_interop2&extensions=WGL_OML_sync_control&extensions=WGL_NV_float_buffer&extensions=WGL_NV_delay_before_swap&extensions=WGL_NV_video_capture&extensions=WGL_ARB_pixel_format_float&extensions=WGL_ARB_create_context_profile&extensions=WGL_NV_swap_group&extensions=WGL_NV_gpu_affinity&extensions=WGL_EXT_pixel_format&extensions=WGL_ARB_extensions_string&extensions=WGL_NV_render_texture_rectangle&extensions=WGL_EXT_create_context_es_profile&extensions=WGL_ARB_robustness_share_group_isolation&extensions=WGL_ARB_create_context_robustness&extensions=WGL_EXT_depth_float&extensions=WGL_EXT_swap_control_tear&extensions=WGL_ARB_context_flush_control&extensions=WGL_ARB_pixel_format&extensions=WGL_ARB_multisample&extensions=WGL_I3D_genlock&extensions=WGL_NV_vertex_array_range&extensions=WGL_3DL_stereo_control&extensions=WGL_EXT_pbuffer&extensions=WGL_EXT_display_color_table&extensions=WGL_NV_video_output&extensions=WGL_ARB_robustness_application_isolation&extensions=WGL_3DFX_multisample&extensions=WGL_I3D_gamma&extensions=WGL_ARB_framebuffer_sRGB&extensions=WGL_NV_copy_image&extensions=WGL_EXT_framebuffer_sRGB&extensions=WGL_NV_present_video&extensions=WGL_EXT_create_context_es2_profile&extensions=WGL_ARB_render_texture&extensions=WGL_ARB_make_current_read&extensions=WGL_EXT_multisample&extensions=WGL_ARB_create_context&extensions=WGL_EXT_extensions_string&extensions=WGL_NV_render_depth_texture&extensions=WGL_ATI_pixel_format_float&extensions=WGL_EXT_swap_control&extensions=WGL_I3D_digital_video_control&extensions=WGL_ARB_pbuffer&extensions=WGL_NV_DX_interop&extensions=WGL_AMD_gpu_association&extensions=WGL_EXT_pixel_format_packed_float&extensions=WGL_EXT_make_current_read&extensions=WGL_I3D_swap_frame_lock&extensions=WGL_ARB_buffer_region
*/
