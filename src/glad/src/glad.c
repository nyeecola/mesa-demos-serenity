/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.34 on Mon Nov 22 09:22:40 2021.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=4.6, gles1=1.0, gles2=3.2
...
PFNTEXSTORAGEATTRIBS2DEXTPROC glad_TexStorageAttribs2DEXT = NULL;
PFNTEXSTORAGEATTRIBS3DEXTPROC glad_TexStorageAttribs3DEXT = NULL;
...
static void load_GL_EXT_texture_storage_compression(GLADloadproc load) {
	...
	glad_TexStorageAttribs2DEXT = (PFNTEXSTORAGEATTRIBS2DEXTPROC)load("TexStorageAttribs2DEXT");
	glad_TexStorageAttribs3DEXT = (PFNTEXSTORAGEATTRIBS3DEXTPROC)load("TexStorageAttribs3DEXT");
}
